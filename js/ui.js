...
function toggleLoading(isLoading) {
  ...
  if (!isLoading) {
    ...
    inE.setAttribute("class", "fas fa-search");
    const sText = document.createTextNode("Search");
    btn.appendChild(inE);
    btn.appendChild(sText);
    btn.disabled = false;
  }
  else {
    let inE = document.createElement("i");
    inE.setAttribute("class","fas fa-hourglass-half");
    const sText = document.createTextNode("Loading ...");
    btn.appendChild(inE);
    btn.appendChild(sText);
    btn.disabled = true;
  }
